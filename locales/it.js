const locale = {
  pages: {
    home: {
      title_1: "La Nostra Storia",
      home_btn_1: "Per saperne di più",
      home_text_1:
        "Noi siamo prima di tutto agricoltori, legati alla nostra terra, alle nostre piante e alle persone che le coltivano e se ne prendono cura. La famiglia di Dora Radino è sempre stata interessata esclusivamente alla produzione di olii di oliva extravergini di altissima qualità, certificati biologici.",
      title_2: "I Nostri Prodotti",
      home_text_2:
        "L’olio di oliva biologico prodotto dalla nostra Azienda Agricola è di colore verde-dorato, leggermente mandorlato, fruttato, e appena piccante.",
    },
    about: {
      about_title: "La Nostra Filosofia",
      about_text_html:
        "Gli uliveti dell’ Azienda Agricola Dora Radino sono situati sulle colline della regione Basilicata generate dal vulcano Vulture, da lungo tempo inattivo. Il suolo vulcanico, naturalmente ricco di minerali, rende queste nostre terre particolarmente fertili e adatte alla coltivazione dell’ ulivo.</br> </br> Quando negli anni ’80 la Signora Dora Radino ha cominciato ad occuparsi dell’azienda agricola di famiglia ha desiderato migliorare ancora di più la produzione agricola introducendo, prima donna in Basilicata, le tecniche ed i capitolati dell’agricoltura biologica certificata.</br> </br> <i>Noi siamo prima di tutto agricoltori, legati alla nostra terra, alle nostre piante e alle persone che le coltivano e se ne prendono cura. </i> </br> </br> Qualche anno fa abbiamo incominciato a vendere anche al dettaglio il nostro olio di oliva biologico in quanto abbiamo voluto offrire ad un prezzo contenuto un olio di altissima qualità, tracciabile dall albero alla tavola sotto il controllo della nostra Azienda.",
    },
    products: {
